...
public sealed class HotkeyCaptureButton : System.Windows.Controls.Button
{
    public static readonly DependencyProperty HotkeyProperty = DependencyProperty.Register(
        nameof(Hotkey), typeof(string), typeof(HotkeyCaptureButton),
    ...
    public static readonly DependencyProperty IsCapturingProperty = DependencyProperty.Register(
        nameof(IsCapturing), typeof(bool), typeof(HotkeyCaptureButton), new PropertyMetadata(false));
    ...
    public static readonly DependencyProperty CaptureStartedCommandProperty = DependencyProperty.Register(
        nameof(CaptureStartedCommand), typeof(ICommand), typeof(HotkeyCaptureButton));
    public static readonly DependencyProperty CaptureCompletedCommandProperty = DependencyProperty.Register(
        nameof(CaptureCompletedCommand), typeof(ICommand), typeof(HotkeyCaptureButton));
    ...
    protected override void OnClick()
    {
        ...
        IsCapturing = true;
        Content = "Press keys...";
        if (CaptureStartedCommand?.CanExecute(null) == true) CaptureStartedCommand.Execute(null);
        Keyboard.Focus(this);
    }
    ...
    protected override void OnPreviewKeyDown(System.Windows.Input.KeyEventArgs e)
    {
        ...
        IsCapturing = false;
        Content = Hotkey;
        if (CaptureCompletedCommand?.CanExecute(null) == true) CaptureCompletedCommand.Execute(null);
    ...
    {
        var button = (HotkeyCaptureButton)d;
        if (!button.IsCapturing) button.Content = e.NewValue?.ToString() ?? string.Empty;
    }
}
