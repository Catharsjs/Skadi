...
public partial class OverlayForm : Form
{
    ...
    private void BuildUI()
    {
        ...
        Location = new Point(screen.Right - 220, screen.Top + 16);
        ...
        _gpuLabel = MakeLabel("GPU: -- % @ -- GHz", y); y += 22;
    ...
    public void UpdateSystemInfo(float cpuLoad, float cpuFreq, float gpuLoad, float gpuFreq, float gpuVram, float ramUsed)
    {
        ...
        _gpuLabel.Text = $"GPU: {gpuLoad:F0}% @ {gpuFreq:F1} GHz";
    ...
    public void SetSystemInfoVisible(bool visible)
    {
        ...
        Size = new Size(200, visible ? 120 : 52);
    }
